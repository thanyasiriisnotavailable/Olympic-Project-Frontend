      ...
      <div class="w-full px-4 mb-3">
        <div class="flex flex-col items-center relative">
              ...
              <div class="text-gray-300 w-8 py-1 pl-2 pr-1 border-l flex items-center border-gray-200">
                ...
                >
                  <svg
                    ...
                    :class="{'rotate-180 transition-transform duration-300 ease-in-out': isDropdownVisible}"
                  >
          ...
          <div
            ...
            class="absolute shadow bg-white top-full z-40 left-0 rounded max-h-60 overflow-y-auto w-full md:w-6/12"
          >
